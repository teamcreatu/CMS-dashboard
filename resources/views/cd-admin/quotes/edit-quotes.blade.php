...
<form action="{{route('edit-quotes',$data['id'])}}" method="POST">
	@csrf
	<div class="row">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Edit Quotes</span>
				</div>
			</div>
				...
				<div class="form-body">
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<div class="portlet-body">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" name="title" placeholder="Enter Quote Title" value="{{$data['title']}}">
									</div>
									@if ($errors->has('title'))
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea type="text" class="form-control" name="summary" placeholder="Enter Summary">{{$data['summary']}}</textarea>
									</div>
						...
						<div class="tab-pane" id="tab_2">
							<div class="portlet-body">
								<div class="form-group">
									<label class="col-md-3 control-label">उद्धरणको शीर्षक </label>
									<div class="col-md-6">
										<input type="text" class="form-control" name="title_ne" placeholder="उद्धरणको शीर्षक प्रविष्ट गर्नुहोस्" value="{{$data['title_ne']}}">
									</div>
									@if ($errors->has('title_ne'))
								...
								<br>
								<div class="form-group">
									<label class="col-md-3 control-label">उद्धरणको सारांश</label>
									<div class="col-md-6">
										<textarea type="text" class="form-control" name="summary_ne" placeholder="उद्धरणको सारांश प्रविष्ट गर्नुहोस्" >{{$data['summary_ne']}}</textarea>
									</div>
									@if ($errors->has('summary_ne'))
