...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-carousel')}}">View Page Sidebar</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
			<span>Edit Page Sidebar</span>
		</li>
	</ul>
</div>
<!-- END PAGE BAR -->

<form action="{{route('edit-page-sidebar',$pageSidebar['id'])}}" method="POST">
	@csrf
	<div class="row">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Edit Page Sidebar</span>
				</div>
			</div>
				...
				<div class="form-body">
					<div class="portlet-body">
						...
						<div class="row">
							...
							<div id="one{{$key}}"><div></div><br><div class="col-md-6"></div><div class="form-group"></div><label class="col-md-3 control-label">Select Page Sidebar<span class="cd-admin-required">*</span></label><div class="col-md-6"></div><select class="form-control" name="custom_widget_title[]"><option disabled="" selected="">Select Widget</option>
