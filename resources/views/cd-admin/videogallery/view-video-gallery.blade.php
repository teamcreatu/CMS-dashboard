    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        ...
        <div class="btn-group pull-right">
          {{-- @if(Gate::check('edit-videogallery','videogallery') || Gate::check('all','all')) --}}
          <a href="{{route('add-video-gallery-form')}}">
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
          ...
          <tbody>
            <tr class="odd gradeX">
              ...
              <td>
                {{-- @if(Gate::check('edit-videogallery','videogallery') || Gate::check('all','all')) --}}
                <form action="{{route('update-video-gallery-status',$v['id'])}}" method="POST">
                  @csrf
                  <div class="btn-group">
                    @if($v->status == 'active')
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <form action="{{route('delete-video-gallery',$v['id'])}}" method="POST">
                  @csrf
