...
<form action="{{route('edit-video-gallery',$data['id'])}}" method="POST">
	@csrf
	<div class="row">
				...
				<div class="row">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet-body">
										<div class="form-group">
											...
											<div>
												<input type="text" class="form-control" name="title" placeholder="Enter Video Title" value="{{$data['title']}}">
											</div>
											@if ($errors->has('title'))
								...
								<div class="tab-pane" id="tab_2">
									<div class="portlet-body">
										<div class="form-group">
											...
											<div>
												<input type="text" class="form-control" name="title_ne" placeholder="भिडियोको शीर्षक प्रविष्ट गर्नुहोस्" value="{{$data['title_ne']}}">
											</div>
											@if ($errors->has('title_ne'))
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<br>
							<div>
								<input type="text" name="video_name" class="form-control" placeholder="Enter Video URL" id="video_url" value="{{$data['video_url']}}">
							</div>
