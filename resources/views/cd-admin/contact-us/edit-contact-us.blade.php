...
<form action="{{route('edit-contact-us',$data['id'])}}" method="POST">
	@csrf
	<div class="row">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Edit Contact Us</span>
				</div>
			</div>
						...
						<div class="tab-pane active" id="tab_1">
							<div class="portlet-body">
								<div class="form-group">
									...
									<br>
									<div>
										<textarea type="text" class="form-control summernote" name="description" placeholder="Enter Video Title">{!!$data['description']!!}</textarea>
									</div>
								...
								<div class="form-group">
									...
									<br>
									<div>
										<input type="url" class="form-control" name="fb_link" placeholder="Enter Facebook Page Link" value="{{$data['fb_link']}}">
									</div>
								...
								<div class="form-group">
									...
									<br>
									<div>
										<input type="url" class="form-control" name="insta_link" placeholder="Enter Instagram Page Link" value="{{$data['insta_link']}}">
									</div>
								...
								<div class="form-group">
									...
									<br>
									<div>
										<input type="url" class="form-control" name="tw_link" placeholder="Enter Twitter Page Link"  value="{{$data['tw_link']}}">
									</div>
								...
								<div class="form-group">
									...
									<br>
									<div>
										<input type="email" class="form-control" name="email_id" placeholder="Enter Video Title" value="{{$data['email_id']}}">
									</div>
								...
								<div class="form-group"> 
									...
									<br>
									<div>
										<input type="number" class="form-control" name="emergency_contact" placeholder="Enter Emergency Contact" value="{{$data['emergency_contact']}}">
									</div>
						...
						<div class="tab-pane" id="tab_2">
							<div class="portlet-body">
								<div class="form-group">
									...
									<div>
										<textarea type="text" class="form-control summernote" name="description_ne" placeholder="वर्णन">{!!$data['description_ne']!!}</textarea>
									</div>
