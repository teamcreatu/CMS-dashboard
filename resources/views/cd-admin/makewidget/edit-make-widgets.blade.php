...
<form action="{{route('edit-make-widgets',$data['id'])}}" method="POST" enctype="multipart/form-data">
	@csrf
	<div class="row">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Edit Make Widgets</span>
				</div>
			</div>
						...
						<div class="tab-pane active" id="tab_1">
							<div class="portlet-body">
								...
								<div class="form-group">
									...
									<div>
										<input type="text" class="form-control" name="title" placeholder="Enter Post Title" value="{{$data['title']}}">
									</div>
									@if ($errors->has('title'))
								...
								<div class="form-group">
									...
									<div>
										<textarea type="text" class="form-control summernote" name="description" id="addLinkEng" id="addImage">{!!$data['description']!!}</textarea>
									</div>
							...
							<div class="tab-pane" id="tab_2">
								<div class="portlet-body">
									...
									<div class="form-group">
										...
										<div>
											<textarea type="text" class="form-control summernote" name="description_ne" id="addLinkNep" id="addImageNep">{!!$data['description_ne']!!}</textarea>
										</div>
										@if ($errors->has('description_ne'))
