...
<div class="page-bar">
	...
	<li>
		<span>View Resource Categories</span>
	</li>
</ul>
</div>
<!-- END PAGE BAR -->
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View Resource Categories </span>
				</div>
				<div class="btn-group pull-right">
					@if(Gate::check('add-documents','documents'))
					<a href="{{route('add-resource-category-form')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Resource Categories
				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					...
					<tbody>
						<tr class="odd gradeX">
							...
							<td>
								@if(Gate::check('edit-documents','documents'))
								<form action="{{route('update-resource-category-status',$c['id'])}}" method="POST">
									@csrf
									<div class="btn-group">
										@if($c->status == 'active')
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<form action="{{route('delete-resource-category',$c['id'])}}" method="POST">
								@csrf
			...
			{{-- Edit Modal --}}
			<div class="modal fade" id="edit-modal{{$c->id}}" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<form class="form-horizontal" action="{{route('edit-resource-category',$c['id'])}}" method="POST">
							@csrf
