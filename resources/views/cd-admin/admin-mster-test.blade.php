...
<head>
    <meta charset="utf-8" />
    <title>OPMCM | Admin Dashboard</title>
    ...
    <link rel="stylesheet" href="{{url('public/cd-admin/css/nepali-date-picker.css')}}"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->

    <link href="{{url('public/cd-admin/assets/global/plugins/bootstrap-colorpicker/css/colorpicker.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{url('public/cd-admin/assets/global/plugins/jquery-nestable/jquery.nestable.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{url('public/cd-admin/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{url('public/cd-admin/assets/global/plugins/select2/css/select2-bootstrap.min.css')}}s" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="http://necolas.github.com/normalize.css/2.0.1/normalize.css">  

    <link href="{{url('public/cd-admin/assets/global/plugins/bootstrap-multiselect/css/bootstrap-multiselect.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{url('public/cd-admin/js/nepali-date-picker.js')}}"></script>

<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="{{url('public/cd-admin/assets/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}" type="text/javascript"></script>
<script src="{{url('public/cd-admin/assets/global/plugins/jquery-nestable/jquery.nestable.js')}}" type="text/javascript"></script>
...
<script src="{{url('public/cd-admin/assets/global/plugins/bootstrap-multiselect/js/bootstrap-multiselect.js')}}" type="text/javascript"></script>
...
<script src="{{url('public/cd-admin/assets/pages/scripts/components-color-pickers.min.js')}}" type="text/javascript"></script>
{{-- <script src="{{url('public/cd-admin/assets/pages/scripts/components-bootstrap-tagsinput.min.js')}}" type="text/javascript"></script> --}}
...
<script src="{{url('public/cd-admin/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js')}}" type="text/javascript"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.4/toastr.min.js"></script>
<script src="{{url('public/cd-admin/assets/pages/scripts/components-select2.min.js')}}" type="text/javascript"></script>

<script src="{{url('public/cd-admin/assets/pages/scripts/components-bootstrap-multiselect.min.js')}}" type="text/javascript"></script>
...
<script type="text/javascript">
    $(function(){
        $('.date-picker-nepali').nepaliDatePicker();
    });
</script>
<script type="text/javascript">
    $(".sortable").sortable();
...
<script>
    ...
    $(document).ready(function(){
        ...
        {
            if('{{Session('language')}}' == 'nep')
            {
                $('.opmcm-en').hide();
                $('.opmcm-ne').show();
                $('.nep').css('display','inline-block');
                var active = document.getElementById('opmcm-nepali');
                document.getElementById("opmcm-nepali").classList.add("active-language");
                document.getElementById("opmcm-english").classList.add("inactive-language");
                document.getElementById("opmcm-english").classList.remove("active-language");
            }
            else
            {
                $('.opmcm-ne').hide();
                ...
                document.getElementById("opmcm-english").classList.add("active-language");
                document.getElementById("opmcm-nepali").classList.add("inactive-language");
                document.getElementById("opmcm-nepali").classList.remove("active-language");
        ...
        var active = document.getElementById('opmcm-english');

        active.className = active.className + ' active-language';

        var inactive = document.getElementById('opmcm-nepali');

        inactive.className = inactive.className + ' inactive-language';
