...
<div class="row">
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit Page Detail</span>
			</div>
		</div>
		@if($errors->any())
		...
		<div class="portlet-body form">
			<form class="form-horizontal" role="form" action="{{url('cd-admin/update-pageDetail/'.$page->id)}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter page category name" name="title" required value="{{$page->title}}"  onchange="changeurl(this.value)">
						</div>
						@if ($errors->has('title'))
					...
					<div class="form-group">
						<label class="col-md-3 control-label"> शीर्षक</label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="title_ne" placeholder=" शीर्षक प्रविष्ट गर्नुहोस्" value="{{$page->title_ne}}">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea type="text" class="form-control summernote" name="description" id="summernote-1">{!!$page->description!!}</textarea>
						</div>
						<div class="col-md-3">
							<div>
					...
					<div class="form-group" id="nepalidesc" style="display: none;">
						<label class=" col-md-3 control-label"> वर्णन <span class="cd-admin-required">*</span></label>
						<div class="col-md-6">
							<textarea type="text" class="form-control summernote" name="description_np" id="summernote" >{!!$page->description_np!!}</textarea>
						</div>
						<div class="col-md-3">
							<div>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control input-large" name="tags" value="{{$page->tags}}" data-role="tagsinput"> </div>
						@if ($errors->has('tags'))
					...
					<div class="form-group">
						...
						<?php $date = explode('-',$page->created_at_nep) ?>
						<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-6 input-group">
							...
							<input type="text" class="form-control" name="url" id="slug" value="{{$page->slug}}">
	...
	<script type="text/javascript">
		...
		function addEnglishSection()
		{
			...
			{
				// console.log($('#summernote_1').summernote('code'));
	...
	<script type="text/javascript">
		function checkSame() {
			...
			if(data == true)
			{
				document.getElementById('nepalidesc').style.display="none";
			}
			else
			{
				document.getElementById('nepalidesc').style.display="block";
			}
		}
	</script>
	<script type="text/javascript">
		function writeDescription() {
			$('#summernote-1').summernote("code",'{{$page->description}}');
		}
	</script>
