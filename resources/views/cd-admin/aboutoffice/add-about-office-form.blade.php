			...
			<form class="form-horizontal" role="form">
				<div class="form-body">
					<div class="form-group">
						<label class="col-md-3 control-label">Office Title</label>
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter Office Title">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">कार्यालयको शीर्षक<small style="color: red">(देवानगिरिमा)</small></label>
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="कार्यालयको शीर्षक प्रविष्ट गर्नुहोस्">
						</div>
					</div>
					<!-- seo section starts -->
					<hr>
