...
<form action="{{route('add-carousel')}}" method="POST">
	@csrf
	<div class="row">
		...
		<div class="portlet light bordered">
			...
			<span class="text-danger">{{ $errors->first('subtitle_ne') }}Please Open the Nepali Tab</span>
			@endif
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet-body">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" name="title" placeholder="Enter Carousel Title" value="{{old('title')}}">
											</div>
											@if ($errors->has('title'))
								...
								<div class="tab-pane" id="tab_2">
									<div class="portlet-body">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="text" class="form-control" name="subtitle_ne" placeholder="Carouselको उपशीर्षक प्रविष्ट गर्नुहोस्" value="{{old('subtitle_ne')}}">
											</div>
