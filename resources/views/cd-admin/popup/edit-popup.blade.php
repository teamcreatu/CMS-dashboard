		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Edit Popup</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="{{route('edit-popup',$data['id'])}}" method="POST">
					@csrf
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div>
								<input type="text" class="form-control" name="title" value="{{$data['title']}}" placeholder="Enter Popup Title">
							</div>
							@if ($errors->has('title'))
						...
						<div class="form-group">
							...
							<div>
								<input type="text" class="form-control" name="title_ne" value="{{$data['title_ne']}}" placeholder="पपअप शीर्षक">
							</div>
							...
							<span class="btn btn-primary" >Add Images</span>
									...
									<div class="form-group">
										...
										<div class="input-group date date-picker " data-date-format="dd-mm-yyyy" data-date-start-date="">
											<input type="text" class="form-control" name="published_date" value="{{$date}}">
										...
										<div class="col-md-6">
											<div class="mt-radio-inline">
												<label class="mt-radio">
													<input type="radio" name="status" id="optionsRadios25" value="active" <?php $data['status'] == 'active'?'checked':''  ?>> Active
													<span></span>
												</label>
												<label class="mt-radio">
													<input type="radio" name="status" id="optionsRadios26" value="inactive" <?php $data['status'] == 'inactive'?'checked':'' ?> checked> Inactive
													<span></span>
												</label>
											</div>
										</div>
