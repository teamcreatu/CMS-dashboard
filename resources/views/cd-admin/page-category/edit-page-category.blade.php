	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-dark sbold uppercase">Edit Page Category</span>
			</div>
		</div>
		@if($errors->any())
		...
		<div class="portlet-body form">
			<form class="form-horizontal" role="form" action="{{url('cd-admin/update-pageCategory/'.$category->id)}}" method="POST" enctype="multipart/form-data">
				@csrf
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" placeholder="Enter page category name" name="name" required value="{{$category->name}}">
						</div>
						@if ($errors->has('name'))
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="title_ne" placeholder=" शीर्षक प्रविष्ट गर्नुहोस्" value="{{$category->title_ne}}">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select class="bs-select form-control" data-live-search="true" data-size="8" name="parent_category">
								<?php $count = 0 ?>
					...
					<div class="form-group">
						...
						<br>
						<div class="col-md-6">
							<input type="text" name="image_name" class="form-control" placeholder="Enter Image URL" id="image" value="{{$category->image_url}}">
						</div>
						<div class="col-md-1">
						...
						<div class="col-md-6">
							<div class="mt-radio-inline">
								<label class="mt-radio">
									<input type="radio" <?php echo $category->status == 'active'?'checked': '' ?> name="status" id="optionsRadios25" value="active" required> Active
									<span></span>
								</label>
								<label class="mt-radio">
									<input type="radio" <?php echo $category->status == 'inactive'?'checked': '' ?> name="status" id="optionsRadios26" value="inactive" required> Inactive
									<span></span>
								</label>
							</div>
						</div>
