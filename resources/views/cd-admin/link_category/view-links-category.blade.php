...
<div class="page-bar">
	...
	<li>
		<span>View Links Categories</span>
	</li>
</ul>
</div>
<!-- END PAGE BAR -->
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View Links Categories </span>
				</div>
				<div class="btn-group pull-right">
					@if(Gate::check('edit-links','links') || Gate::check('all','all'))
					<a href="{{route('add-links-category-form')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Links Categories
				...
				<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
					...
					<tbody>
						<tr class="odd gradeX">
							...
							<td>
								@if(Gate::check('edit-links','links') || Gate::check('all','all'))	
								<form action="{{route('update-links-category-status',$c['id'])}}" method="POST">
									@csrf
									<div class="btn-group">
										@if($c->status == 'active')
									...
									<button class="btn btn-xs green dropdown-toggle" type="button" >Active
										...
										<td>
											<a data-toggle="modal" href="#modal-edit{{$c['id']}}">
												<button class="label label-sm label-primary" data-toggle="tooltip" title="Edit">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<form action="{{route('delete-links-category',$c['id'])}}" method="POST">
								@csrf
			...
			<div class="modal fade" id="modal-edit{{$c['id']}}" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" action="{{route('edit-links-category',$c['id'])}}" method="POST">
							@csrf
