...
<form action="{{route('edit-events',$data['id'])}}" method="POST">
	@csrf
	<div class="row">
						...
						<div class="tab-pane active" id="tab_1">
							<div class="portlet-body">
								...
								<div class="form-group">
									...
									<div>
										<input type="text" class="form-control" name="title" placeholder="Enter Event Title" value="{{$data['title']}}">
									</div>
									@if ($errors->has('title'))
								...
								<div class="form-group">
									...
									<div>
										<textarea type="text" class="form-control summernote" name="description">{!!$data['description']!!}</textarea>
									</div>
								...
								<div class="form-group">
									...
									<div class="input-group date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="">
										<input type="text" class="form-control" name="event_date" value="{{$data['event_date']}}">
						...
						<div class="tab-pane" id="tab_2">
							<div class="portlet-body">
								...
								<div class="form-group">
									...
									<div>
										<textarea type="text" class="form-control summernote" name="description_ne">{!!$data['description_ne']!!}</textarea>
									</div>
									@if ($errors->has('description_ne'))
