...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{route('view-page-sidebar')}}">View Footer</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Add Footer</span>
				</div>
			</div>
				...
				<div class="form-body">
					<div class="portlet-body">
						<div class="row">
							<div id="dynamicInput">
								<div id="one1">
									<br><div class="form-group"></div><label class="col-md-3 control-label">Select Footer<span class="cd-admin-required">*</span></label><div class="col-md-6"></div><select class="form-control" name="custom_widget_title[]"><option disabled="" selected="">Select Widget</option>
