...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('cd-admin/view-members')}}">View Staff</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
			<span>Add Staff</span>
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark sbold uppercase">Add Staff</span>
				</div>
			</div>
				...
				<div class="row">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet-body">
										...
										<div class="form-group col-md-12">
											...
											<div>
												<input type="text" class="form-control" name="name" placeholder="Enter Staff Name" value="{{old('name')}}">
											</div>
											@if ($errors->has('name'))
										...
										<div class="form-group col-md-6" id="remove2" style="display: none;">
											<label class="control-label">From-To Date</label>
											<div>
												<textarea type="text" class="form-control" name="from_to" value="{{old('from_to')}}" style="height: 35px;">{{old('from_to')}}</textarea>
											</div>
										...
										<div class="form-group col-md-6">
											...
											<div>
												<input type="text" class="form-control" name="post" placeholder="Enter Post" value="{{old('post')}}" required>
											</div>
											@if ($errors->has('post'))
										...
										<div class="form-group col-md-6" id="remove10">
											<label class="control-label">Section</label>
											<div>
												<input type="text" class="form-control" name="section" placeholder="Enter Section" value="{{old('section')}}" >
											</div>
										...
										<div class="form-group col-md-12" id="remove7">
											<label class=" control-label">Summary</label>
											<div>
												<textarea type="text" class="form-control summernote" name="summary" placeholder="Write Something about the staff">{{old('summary')}}</textarea>
											</div>
										...
										<div class="form-group col-md-12">
											...
											<div>
												<textarea type="text" class="form-control summernote" name="bio" placeholder="Write Something about the staff">{{old('bio')}}</textarea>
											</div>
											@if ($errors->has('bio'))
								...
								<div class="tab-pane" id="tab_2">
									<div class="portlet-body">
										<div class="form-group col-md-12">
											...
											<div>
												<input type="text" class="form-control" name="name_ne" placeholder="फोटो शीर्षक प्रविष्ट गर्नुहोस्" value="{{old('name_ne')}}">
											</div>
											@if ($errors->has('name_ne'))
										...
										<div class="form-group col-md-6" id="remove6">
											<label class="control-label">Section</label>
											<div>
												<input type="text" class="form-control" name="section_ne" placeholder="Enter Section(देवानगिरिमा)" value="{{old('section_ne')}}">
											</div>
											@if ($errors->has('section_ne'))
										...
										<div class="form-group col-md-6">
											...
											<div>
												<input type="text" class="form-control" name="post_ne" placeholder="Enter Post(देवानगिरिमा)" value="{{old('post_ne')}}">
											</div>
											@if ($errors->has('post_ne'))
											<span class="text-danger">{{ $errors->first('post_ne') }}</span>
											@endif
										</div>
										<div class="form-group col-md-6" id="remove3" style="display: none;">
											<label class="control-label">From-To Date Nepali</label>
											<div>
												<textarea type="text" class="form-control" name="from_to_ne" value="{{old('from_to_ne')}}" style="height: 35px;">{{old('from_to_ne')}}</textarea>
											</div>
											@if ($errors->has('from_to_ne'))
											<span class="text-danger">{{ $errors->first('from_to_ne') }}</span>
											@endif
										</div>
										<div class="form-group col-md-12" id="remove5">
											<label class=" control-label">Summary(In Nepali)</label>
											<div>
												<textarea type="text" class="form-control summernote" name="summary_ne" placeholder="Write Something about the staff">{{old('summary_ne')}}</textarea>
											</div>
										...
										<div class="form-group col-md-12">
											...
											<div>
												<textarea type="text" class="form-control summernote" name="bio_ne" placeholder="Write Something about the staff">{{old('bio_ne')}}</textarea>
											</div>
					...
					<div class="col-md-6">
						<div class="form-body">
								...
								<div>
									<div class="mt-radio-inline">
										<label class="mt-radio">
											<input type="radio" name="is_expm" id="optionsRadios25" value="yes" <?php echo old('is_expm') == 'yes'?'checked':'' ?>  onclick="checkPM()"> Yes 
											<span></span>
										</label>
										<label class="mt-radio">
											<input type="radio" name="is_expm" id="optionsRadios26" value="no" <?php echo old('is_expm') == 'no'?'checked':'' ?> checked onclick="checkPM()"> No
											<span></span>
										</label>
									</div>
								</div>
								...
								<div>
									<div class="mt-radio-inline">
										<label class="mt-radio" style="margin-bottom: 0;">
											<input type="radio" name="is_excs" id="optionsRadios25" value="yes" <?php echo old('is_excs') == 'yes'?'checked':'' ?>  onclick="checkCS()"> Yes 
											<span></span>
										</label>
										<label class="mt-radio" style="margin-bottom: 0;">
											<input type="radio" name="is_excs" id="optionsRadios26" value="no" <?php echo old('is_excs') == 'no'?'checked':'' ?> checked onclick="checkCS()"> No
											<span></span>
										</label>
									</div>
								</div>
							...
							<div class="form-group col-md-6" id="remove9">
							...
							<div class="form-group col-md-6" id="remove8">
								<label class="control-label">Contact Number</label>
								<div>
									<input type="number" class="form-control" name="contact_no" placeholder="Enter Contact Number" value="{{old('contact_no')}}">
								</div>
							...
							<div class="form-group col-md-3">
								...
								<div>
									<input type="number" class="form-control" name="order" placeholder="Enter Order Number" value="{{old('order')}}">
								</div>
								@if ($errors->has('order'))
