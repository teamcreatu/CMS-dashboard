					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<div class="portlet-body">
								...
								<div class="form-group col-md-4" id="remove2" style="display: none;">
									<label class="control-label">From-To Date</label>
									<div>
										<textarea type="text" class="form-control" name="from_to" value="{{old('from_to')}}">{{old('from_to')}}</textarea>
									</div>
								...
								<div class="form-group col-md-3" id="remove10">
								...
								<div class="form-group col-md-3" id="remove9">
								...
								<div class="form-group col-md-3" id="remove8">
						...
						<div class="tab-pane" id="tab_2">
							<div class="portlet-body">
								...
								<div class="form-group col-md-4" id="remove6">
									<label class="control-label">Section</label>
									<div>
								...
								<div class="form-group col-md-4" id="remove3" style="display: none;">
									<label class="control-label">From-To Date Nepali</label>
									<div>
										<textarea type="text" class="form-control" name="from_to_ne" value="{{old('from_to_ne')}}">{{old('from_to_ne')}}</textarea>
									</div>
