...
<div class="page-bar">
	...
	<li>
		<span>View Staffs Categories</span>
	</li>
</ul>
</div>
<!-- END PAGE BAR -->
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-dark">
					...
					<span class="caption-subject bold uppercase"> View Staffs Categories </span>
				</div>
				<div class="btn-group pull-right">
					@if(Gate::check('add-staffs','staffs'))
					<a href="{{route('add-members-category-form')}}">
						<button id="sample_editable_1_new" class="btn sbold green"> Add Staffs Categories
					...
					<tbody>
						<tr class="odd gradeX">
							...
							<td>
								...
								<form action="{{route('update-members-category-status',$c['id'])}}" method="POST">
									@csrf
									<div class="btn-group">
										@if($c->status == 'active')
									...
									@else
									@if($c->status == 'active')
									<button class="btn btn-xs green dropdown-toggle" type="button" >Active
										@else
										<button class="btn btn-xs red dropdown-toggle" type="button">Inactive
											@endif
											@endif
										</td>
										<td>
											...
											@endif
											@if(Gate::check('delete-staffs','staffs'))

											<a data-toggle="modal" href="#delete-modal{{$c['id']}}">
												<button class="label label-sm label-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i>
												</button>														
											</a>
											@endif
										</td>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<form action="{{route('delete-members-category',$c['id'])}}" method="POST">
								@csrf
			...
			<div class="modal fade" id="modal-edit{{$c['id']}}" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" action="{{route('edit-members-category',$c['id'])}}" method="POST">
							@csrf
							<div class="modal-body">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" name="order_no" placeholder=" Enter The Category Priority" value="{{$c['order_no']}}">
										</div>
