...
<div class="row">
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body form">
			<form class="form-horizontal" method="post" action="{{url('cd-admin/updateRole/'.$role->id)}}" role="form">
				@csrf
				<div class="form-body">
					...
					<div class="">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="mt-radio-inline">
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="create{{$p['name']}}" id="optionsRadios25" value="create" <?php echo $p['name'] == in_array('create', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Create
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="edit{{$p['name']}}" id="optionsRadios26" value="edit" <?php echo $p['name'] == in_array('edit', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Edit
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="delete{{$p['name']}}" id="optionsRadios26" value="delete" <?php echo $p['name'] == in_array('delete', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Delete
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="radio" name="{{$p['name'].'_radio'}}" id="all{{$p['name']}}" id="optionsRadios26" value="all" <?php echo $p['name'] == in_array('all', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}btnSearch_Click{{$p['name']}}();" multiple id="{{$p['name']}}"> All
										<span></span>
									</label>
									<label class="mt-radio">
							...
							<div id="staffs" <?php echo isset($p['category']) ?'style="display: block; clear:both;"':'style="display: none; clear:both;"' ?>>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="mt-radio-inline">
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="create{{$p['name']}}" id="optionsRadios26" value="create" <?php echo $p['name'] == in_array('create', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Create
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="edit{{$p['name']}}" id="optionsRadios26" value="edit" <?php echo $p['name'] == in_array('edit', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Edit
									...
									<label class="mt-radio">
										<input type="radio" name="{{$p['name'].'_radio'}}" id="none{{$p['name']}}" id="optionsRadios26" value="none" <?php echo $p['name'] == in_array('none', $p['mode'])?'checked':''  ?> onclick="{{$p['name']}}btnSearch_Click{{$p['name']}}();"  multiple id="{{$p['name']}}"> None
										<span></span>
									</label>
								</div>
							</div>
							<hr>
							<div id="documents" <?php echo isset($p['category']) ?'style="display: block; clear:both;"':'style="display: none; clear:both;"' ?>>
								<label class="col-md-3 control-label">{{ucfirst($p['name'])}}'s Categories</label>
								<div class="col-md-6">
									<select class="mt-multiselect btn btn-default form-control" name="mode{{$p['name']}}[]" multiple="multiple" data-label="left" data-select-all="true" data-width="100%" data-filter="true" data-action-onchange="true" data-height="300">
										@if(isset($p['category']))
										@foreach($rescat as $rc)
										@if(in_array($rc['id'],$p['category']))
						...
						<div class="form-group">
							...
							<div id="post" <?php echo isset($p['category']) ?'style="display: block; clear:both;"':'style="display: none; clear:both;"' ?>>
								<label class="col-md-3 control-label" >{{ucfirst($p['name'])}}'s Categories</label>
								<div class="col-md-6">
									<select class="mt-multiselect btn btn-default form-control" name="mode{{$p['name']}}[]" multiple="multiple" data-label="left" data-select-all="true" data-width="100%" data-filter="true" data-action-onchange="true" data-height="300">
										@if(isset($p['category']))
										@foreach($newcat as $ec)
										@if(in_array($ec['id'],$p['category']))
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="mt-radio-inline">
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="create{{$p['name']}}" id="optionsRadios25" value="create" <?php echo $p['name'] == in_array('create', $p['mode'])?'checked':''  ?> onclick="checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Create
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="edit{{$p['name']}}" id="optionsRadios26" value="edit" <?php echo $p['name'] == in_array('edit', $p['mode'])?'checked':''  ?> onclick="checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Edit
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="checkbox" name="{{$p['name']}}[]" id="delete{{$p['name']}}" id="optionsRadios26" value="delete" <?php echo $p['name'] == in_array('delete', $p['mode'])?'checked':''  ?> onclick="checkbox{{$p['name']}}();" multiple id="{{$p['name']}}"> Delete
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="radio" name="{{$p['name'].'_radio'}}" id="all{{$p['name']}}" id="optionsRadios26" value="all" <?php echo $p['name'] == in_array('all', $p['mode'])?'checked':''  ?> onclick="btnSearch_Click{{$p['name']}}();" multiple id="{{$p['name']}}"> All
										<span></span>
									</label>
									<label class="mt-radio">
										<input type="radio" name="{{$p['name'].'_radio'}}" id="none{{$p['name']}}" id="optionsRadios26" value="none" <?php echo $p['name'] == in_array('none', $p['mode'])?'checked':''  ?> onclick="btnSearch_Click{{$p['name']}}();"  multiple id="{{$p['name']}}"> None
										<span></span>
									</label>
								</div>
							</div>
